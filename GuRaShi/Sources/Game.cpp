...
// TODO: 弾のスピードを速くし、弾が画面右端を通り越したら再度発射可能にする。(D)　hw16a118_谷口遼樹
// TODO: スコアのサイズを大きくする。(E) HW16A118_谷口遼樹
// TODO: スコアを100点ずつ加算するようにし、5桁の表示に変える。(F) HW16A118_谷口遼樹
